...
HOME_SINGLE_TITLE = "检测结果"
HOME_SINGLE_DESC = "确认歌曲信息后可直接在主窗口下载。"
STATUS_IDLE = "状态：待输入"
...
STATUS_BATCH_ROUTE = "状态：多链接或歌单将进入批量下载。"
...
INLINE_DOWNLOAD_READY = "已就绪，可开始下载。"
INLINE_DOWNLOAD_UNAVAILABLE = "当前歌曲不可下载：{reason}"
INLINE_DOWNLOAD_PREVIEW = "输出：{path}"
INLINE_DOWNLOAD_PICK_DIR = "选择"
INLINE_DOWNLOAD_DIR = "保存目录"
INLINE_DOWNLOAD_NAME = "文件名"
INLINE_DOWNLOAD_FORMAT = "格式"
INLINE_DOWNLOAD_PAUSED = "下载已暂停。"
INLINE_DOWNLOAD_CANCELING = "正在取消下载..."
...
MANAGER_SEARCH_LABEL = "搜索"
MANAGER_SEARCH_PLACEHOLDER = "歌曲名、ID、文件名、路径或错误码"
MANAGER_BTN_PREVIOUS_PAGE = "上一页"
MANAGER_BTN_NEXT_PAGE = "下一页"
MANAGER_PAGE_SUMMARY = "第 {current} / {total} 页 · 共 {count} 条"
MANAGER_BTN_EXPORT_CSV = "导出 CSV"
MANAGER_EXPORT_TITLE = "导出下载历史"
MANAGER_EXPORT_FILTER = "CSV 文件 (*.csv)"
MANAGER_EXPORT_EMPTY = "当前筛选条件下没有可导出的记录。"
MANAGER_EXPORT_DONE = "下载历史已导出：\n{path}"
MANAGER_EXPORT_FAILED = "下载历史导出失败：{message}"
...
DIAGNOSTICS_DESC = "查看脱敏后的运行环境、网络连通性和最近日志，并可导出排障报告。"
DIAGNOSTICS_OVERVIEW_GROUP = "运行概览"
DIAGNOSTICS_VERSION = "应用版本"
DIAGNOSTICS_LOGIN = "登录凭证"
DIAGNOSTICS_LOGIN_READY = "已配置 MUSIC_U"
DIAGNOSTICS_LOGIN_MISSING = "未配置 MUSIC_U"
DIAGNOSTICS_PROXY = "网络代理"
DIAGNOSTICS_FFMPEG = "ffmpeg"
DIAGNOSTICS_AVAILABLE = "可用"
DIAGNOSTICS_UNAVAILABLE = "不可用"
DIAGNOSTICS_LATEST_TASK = "最近任务"
DIAGNOSTICS_NO_TASK = "暂无"
DIAGNOSTICS_NETWORK_GROUP = "网络检测"
DIAGNOSTICS_NETWORK_TARGET = "检测目标"
DIAGNOSTICS_NETWORK_STATUS = "状态"
DIAGNOSTICS_NETWORK_DETAIL = "详情"
DIAGNOSTICS_NOT_CHECKED = "未检测"
DIAGNOSTICS_CHECKING = "检测中..."
DIAGNOSTICS_REACHABLE = "可达"
DIAGNOSTICS_UNREACHABLE = "不可达"
DIAGNOSTICS_BTN_RUN = "运行网络检测"
DIAGNOSTICS_BTN_RUNNING = "正在检测..."
DIAGNOSTICS_LOG_GROUP = "最近日志（已脱敏）"
DIAGNOSTICS_LOG_EMPTY = "暂无 WARNING / ERROR 日志。"
DIAGNOSTICS_BTN_REFRESH_LOG = "刷新日志"
DIAGNOSTICS_BTN_OPEN_LOG_DIR = "打开日志目录"
DIAGNOSTICS_BTN_EXPORT = "导出诊断报告"
DIAGNOSTICS_EXPORT_TITLE = "导出诊断报告"
DIAGNOSTICS_EXPORT_FILTER = "文本文件 (*.txt)"
DIAGNOSTICS_EXPORT_DONE = "诊断报告已导出：\n{path}"
DIAGNOSTICS_EXPORT_FAILED = "诊断报告导出失败：{message}"
DIAGNOSTICS_LOG_DIR_MISSING = "日志目录不存在：{path}"
DIAGNOSTICS_WAIT_FOR_CHECK = "网络检测仍在运行，请等待完成后再关闭。"
...
BATCH_BTN_CANCEL_DETECT = "取消识别"
BATCH_BTN_CANCELING_DETECT = "正在取消..."
...
BATCH_STATUS_DETECT_CANCELING = "状态：正在取消批量识别..."
BATCH_STATUS_DETECT_CANCELED = "识别已取消：保留 {completed} 条已完成结果，可下载已识别项目或重新识别。"
...
ACC_SINGLE_RESULT = "单曲检测结果"
ACC_SINGLE_DIR = "单曲保存目录"
ACC_SINGLE_PICK_DIR = "单曲选择保存目录按钮"
ACC_SINGLE_NAME = "单曲文件名"
ACC_SINGLE_FORMAT = "单曲下载格式"
ACC_SINGLE_DOWNLOAD = "单曲开始下载按钮"
ACC_SINGLE_PAUSE = "单曲暂停或恢复按钮"
ACC_SINGLE_CANCEL = "单曲取消下载按钮"
